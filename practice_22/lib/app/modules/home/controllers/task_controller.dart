...
await DatabaseHelper.instance.updateData(TaskModel(title: addTaskController!.text));
taskData.insert(0, TaskModel(id: taskData.length, title: addTaskController!.text));
addTaskController!.clear();
}
