...
class Chapter4CreativeView extends GetView<Chapter4CreativeController> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('৪র্থ  অধ্যায় সৃজনশীল প্রশ্নের উত্তর'),
          centerTitle: true,
                        ...
                        children: [
                          Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                   Get.toNamed(Routes.CHAPTERCQ4_PDF);
                          ...
                          Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                   Get.toNamed(Routes.CHAPTER4CQ_2016);
                                },
                                child: Container(
                                  // color: Colors.blueGrey,
                                  height: 100,
