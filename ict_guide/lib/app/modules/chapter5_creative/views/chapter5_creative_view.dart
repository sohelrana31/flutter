...
class Chapter5CreativeView extends GetView<Chapter5CreativeController> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('৫ম অধ্যায় সৃজনশীল প্রশ্নের উত্তর'),
          centerTitle: true,
                        ...
                        children: [
                          Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  Get.toNamed(Routes.CHAPTERCQ5_PDF);
                          ...
                          Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                    Get.toNamed(Routes.CHAPTER5CQ_2016);
                                },
                                child: Container(
                                  // color: Colors.blueGrey,
                                  height: 100,
