...
class Chapter2CreativeView extends GetView<Chapter2CreativeController> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('২য় অধ্যায় সৃজনশীল প্রশ্নের উত্তর'),
          centerTitle: true,
                        ...
                        children: [
                          Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                   Get.toNamed(Routes.CHAPTERCQ2_PDF);
                          ...
                          Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                   Get.toNamed(Routes.CHAPTER2CQ_2016);
                                },
                                child: Container(
                                  // color: Colors.blueGrey,
                                  height: 100,
